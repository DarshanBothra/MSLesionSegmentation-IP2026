...
DATASET_ROOT = "/home/darshan/MS/data/RAW/MICCAI2016"
...
OUTPUT_JSON_PATH = "/home/darshan/MS/eda/results/exploratory/miccai2016_eda.json"
            ...
            for center in centers:
                ...
                for patient in patients:
                    ...
                    if mode in output[batch][center][patient]["present"]:
                        img_dims, orientation = get_image_dims(root, center, patient, mode)
